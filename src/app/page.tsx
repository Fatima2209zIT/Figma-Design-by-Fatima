export default function Home() {
  return (
    <div className="bg-[#252B42] min-h-screen flex flex-col items-center">
      {/* navbar section */}
      <nav className="w-full py-8 flex items-center px-12 space-x-12">
        <h3 className="text-white font-bold text-xl ml-[30px] hover:text-gray-300">BrandName</h3>
        {/* navigation text */}
        <div className="flex flex-grow items-center space-x-8 ml-[90px]">
        ...
        <div className="flex space-x-4">
          <a href="#" className="text-white py-2 px-4 rounded hover:bg-blue-400">Login</a>
